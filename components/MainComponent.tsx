...
export default function MainComponent() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 min-h-screen max-w-screen-lg mx-auto justify-start items-start p-4 md:p-10 gap-4 md:gap-15 border my-10 bg-gray-600/20 border-white/50">
      <div>
